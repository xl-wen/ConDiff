...
> Xilin Wen, Xu-Hua Yang, Gang-Feng Ma. 2026. Information Processing & Management
...
python main.py --cuda --dataset=yelp2018 --data_path=../datasets/yelp/ --lr=5e-6 --weight_decay=1e-3 --batch_size=400 --dims=[4000] --emb_size=10 --mean_type=x0 --steps=5 --noise_scale=0.1 --noise_min=0.01 --noise_max=0.1 --sampling_steps=0 --reweight=1 --log_name=log --round=1 --gpu=0 --lamd1 0.1 --lamd2 0.1
```
